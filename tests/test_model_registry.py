...
def test_create_model_routes_whisper_ids_to_whisper_adapter(monkeypatch) -> None:
...
def test_create_model_routes_hf_ids_to_transformers_adapter(monkeypatch) -> None:
    calls: list[dict[str, str]] = []
...
def test_create_models_reports_unavailable_backends(monkeypatch) -> None:
...
def test_create_model_rejects_unknown_model_id() -> None:
