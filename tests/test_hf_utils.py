...
def test_configure_hf_cache_sets_expected_environment(monkeypatch, tmp_path: Path) -> None:
...
def test_read_hf_token_supports_legacy_env_name(monkeypatch) -> None:
...
def test_call_hf_loader_with_token_fallback_retries_use_auth_token() -> None:
